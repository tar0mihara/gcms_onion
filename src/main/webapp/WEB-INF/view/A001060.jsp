...
<head>
<meta charset="UTF-8">
<title>スタッフ区分一覧 |スタッフ区分管理 | 作業ガイドライン インデックス</title>
...
<body id="A001060" class="pageType01 oneColumn"><div id="Container">
...
<div id="ContentMainArea">
	...
	<h1 class="h1Basic01 sectS"><span class="h1Inr01">スタッフ区分一覧</span></h1>
