...
<head>
<meta charset="UTF-8">
<title>施設登録 | マスタ登録 | 作業ガイドライン インデックス</title>
...
<body id="A001080" class="pageType01 oneColumn"><div id="Container">
...
<div id="ContentMainArea">
	...
	<h1 class="h1Basic01 sectS"><span class="h1Inr01">施設登録</span></h1>
	...
	<table class="tbl01 sectM">
			...
			<tbody>
				...
				<!-- row -->
				<tr>
					<th><label for="">施設名</label></th>
					<td><input type="text" name="" id="" class="inpTxt01"></td>
				</tr>
				<!-- /row -->
				<!-- row -->
				<tr>
					<th><label for="">施設定員</label></th>
					<td><input type="text" name="" id="" class="inpTxt01"></td>
				</tr>
				<!-- /row -->
				<!-- row -->
				<tr>
					...
					<td><textarea name="" id="" cols="30" rows="10" class="inpTxtArea01"></textarea></td>
				</tr>
				<!-- /row -->
			</tbody>
		</table>
